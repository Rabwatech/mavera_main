  ...
  return (
    <div className="min-h-screen rtl" dir="rtl">
      ...
      <div className="sr-only">
        ...
        <p>
          قاعة أزهار فاخرة في جدة بسعة 300 ضيف، شرفة بانورامية، إضاءة متطورة،
          ونظام صوتي احترافي. احجز الآن لحفلتك الأنيقة
        </p>
        <meta
          name="description"
          content="قاعة الأزهار في مافيرا - قاعة أفراح أنيقة في جدة بسعة 300 ضيف، شرفة بانورامية، إضاءة متطورة، ونظام صوتي احترافي لحفلات الزفاف والمناسبات"
        />
        <meta
          name="keywords"
          content="قاعة الأزهار جدة, قاعات أفراح أنيقة جدة, حفلات زفاف جدة, شرفة بانورامية جدة"
        />
      </div>
      ...
      >
        ...
        <div
          className={`relative z-10 text-center px-8 max-w-5xl mx-auto text-white transition-all duration-1000 ${
            isHeroVisible
        ...
        >
          ...
          <h1
            className="text-6xl md:text-8xl font-extralight mb-8 tracking-[0.1em] leading-[0.9]"
            style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            {quickFacts.map((fact, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-[#2D2926] mb-3 text-center">
                  {fact.label}
                </h3>
                {/* الوصف أسفل العنوان */}
                <p className="text-[#766B5A] font-light text-center text-sm">
                  {fact.value}
                </p>
              </div>
            ))}
      ...
      <section
        ref={storyRef}
        className="py-32 bg-gradient-to-b from-[#FAF9F7] to-[#F8F6F2] relative overflow-hidden"
      >
        <div className="absolute inset-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-[#766B5A] leading-relaxed font-light text-right">
                <p>
                  قاعة الأزهار هي تحفة من تحف التصميم الكلاسيكي، حيث تجمع بين
                  الأناقة التقليدية والحداثة العصرية. سميت بالأزهار لتميزها
                  بالجمال الطبيعي والرومانسية.
                </p>

                <p>
                  مع شرفتها البانورامية الفريدة، ونظام الإضاءة المتطور، ونظام
                  الصوت الاحترافي، تضمن قاعة الأزهار أن تكون مناسبتكم مميزة
                  ومريحة في نفس الوقت.
                </p>
              </div>
      ...
      <section ref={galleryRef} className="py-32 bg-white">
        <div className="max-w-6xl mx-auto px-8 lg:px-12">
          ...
          >
            <div
              className="relative overflow-hidden rounded-[2rem] shadow-[0_24px_80px_rgba(0,0,0,0.12)] cursor-pointer group"
        ...
        <div className="max-w-6xl mx-auto px-8 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-white p-8 rounded-[2rem] shadow-[0_8px_32px_rgba(0,0,0,0.06)] hover:shadow-[0_24px_80px_rgba(196,157,47,0.15)] transition-all duration-700 hover:-translate-y-2"
              >
                <div className="flex items-center mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star
                      key={i}
                      className="w-5 h-5 text-[#C49D2F] fill-current"
                    />
                  ))}
                </div>
                ...
                <div>
                  <h4 className="text-lg font-medium text-[#2D2926]">
                    {testimonial.name}
                  </h4>
      ...
      <section
        ref={decisionRef}
        className="py-32 bg-gradient-to-br from-white to-[#FAF9F7]"
      >
        <div className="max-w-6xl mx-auto px-8 lg:px-12">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extralight text-[#2D2926] mb-8 tracking-[0.05em]">
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  {
                    text: "تريدون شرفة بانورامية للمناظر الخلابة",
                    icon: Flower,
                  },
                  {
                    text: "تحبون الإضاءة المتطورة والتصميم العصري",
                    icon: Star,
                  },
                  ...
                  >
                    ...
                    <span className="text-[#766B5A] text-lg font-light text-right">
                      {item.text}
                    </span>
                  </div>
                ))}
      ...
      <section
        ref={ctaRef}
        className="py-32 bg-gradient-to-br from-[#2D2926] to-[#1a1a1a] relative overflow-hidden"
      >
        <div className="absolute inset-0">
          <img
        ...
        <div
          className={`max-w-4xl mx-auto px-8 text-center relative z-10 transition-all duration-1000 ${
            isCTAVisible
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
