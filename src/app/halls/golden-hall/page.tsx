...
import GoldenHallWizard from '../../../components/GoldenHallWizard'
...
export default function GoldenHallPage() {
  ...
  const galleryImages = [
    {
      ...
      alt: 'قاعة الذهبية - منظر عام للقاعة الفاخرة'
    },
    {
      src: 'https://images.pexels.com/photos/1444442/pexels-photo-1444442.jpeg?auto=compress&cs=tinysrgb&w=800',
      alt: 'قاعة الذهبية - التصميم الداخلي الفاخر'
    },
    {
      src: 'https://images.pexels.com/photos/1444424/pexels-photo-1444424.jpeg?auto=compress&cs=tinysrgb&w=800',
      alt: 'قاعة الذهبية - نظام الإضاءة المتطور'
    },
    {
      src: 'https://images.pexels.com/photos/1444442/pexels-photo-1444442.jpeg?auto=compress&cs=tinysrgb&w=800',
      alt: 'قاعة الذهبية - نظام الصوت الاحترافي'
    },
    {
      src: 'https://images.pexels.com/photos/1444424/pexels-photo-1444424.jpeg?auto=compress&cs=tinysrgb&w=800',
      alt: 'قاعة الذهبية - منطقة الاستقبال والضيافة'
    },
    {
      src: 'https://images.pexels.com/photos/1444442/pexels-photo-1444442.jpeg?auto=compress&cs=tinysrgb&w=800',
      alt: 'قاعة الذهبية - المطبخ الحديث والمعدات المتطورة'
    },
    {
      src: 'https://images.pexels.com/photos/1444424/pexels-photo-1444424.jpeg?auto=compress&cs=tinysrgb&w=800',
      alt: 'قاعة الذهبية - التصميم الداخلي الفاخر'
    ...
    {
      src: 'https://images.pexels.com/photos/1444442/pexels-photo-1444442.jpeg?auto=compress&cs=tinysrgb&w=800',
      alt: 'قاعة الذهبية - المرافق والخدمات'
    }
  ]
  ...
  const testimonials = [
    {
      name: 'خالد الزهراني',
      event: 'حفل زفاف',
      text: 'قاعة الذهبية تجمع بين الأناقة والفخامة. التصميم العصري كان إضافة رائعة لحفلنا. أنصح بها بشدة.',
      rating: 5
    },
    {
      name: 'ريم العتيبي',
      event: 'حفل خطوبة',
      text: 'تصميم عصري جميل مع مرافق حديثة. الإضاءة المتطورة أضافت لمسة سحرية لحفلنا.',
      rating: 5
    },
    {
      name: 'فهد المطيري',
  ...
  const quickFacts = [
    { icon: Users, label: 'السعة', value: '250 ضيف' },
    { icon: Crown, label: 'الأفضل لـ', value: 'حفلات الزفاف المتوسطة' },
    { icon: Shield, label: 'المرافق', value: 'إضاءة متطورة، نظام صوت احترافي' },
    { icon: Heart, label: 'الطعام', value: 'بوفيه فاخر متوفر' },
    { icon: Star, label: 'المرونة', value: 'تصميم عصري أنيق' }
  ]
  ...
  return (
    <div className="min-h-screen rtl" dir="rtl">
      ...
      <div className="sr-only">
        <h1>قاعة الذهبية - قاعة أفراح فاخرة في جدة</h1>
        <p>قاعة ذهبية فاخرة في جدة بسعة 250 ضيف، إضاءة متطورة، ونظام صوتي احترافي. احجز الآن لحفلتك الأنيقة</p>
        <meta name="description" content="قاعة الذهبية في مافيرا - قاعة أفراح فاخرة في جدة بسعة 250 ضيف، إضاءة متطورة، ونظام صوتي احترافي لحفلات الزفاف والمناسبات" />
        <meta name="keywords" content="قاعة الذهبية جدة, قاعات أفراح فاخرة جدة, حفلات زفاف جدة, إضاءة متطورة جدة" />
      </div>
      ...
      <section ref={heroRef} className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className={`relative z-10 text-center px-8 max-w-5xl mx-auto text-white transition-all duration-1000 ${
          ...
          <p className="text-2xl md:text-3xl font-light tracking-[0.05em] leading-relaxed max-w-3xl mx-auto mb-12 opacity-90">
            حيث الفخامة تلتقي بالحداثة، وكل لحظة تصبح ذكرى خالدة
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className={`transition-all duration-1000 ${
              ...
              <div className="space-y-6 text-lg text-[#766B5A] leading-relaxed font-light text-right">
                <p>
                  قاعة الذهبية هي تحفة من تحف التصميم العصري، حيث تجمع بين الفخامة التقليدية والحداثة العصرية. 
                  سميت بالذهبية لتميزها بالأناقة والجودة العالية.
                </p>
                
                <p>
                  مع نظام الإضاءة المتطور، ونظام الصوت الاحترافي، ونظام التكييف المتطور، 
                  تضمن قاعة الذهبية أن تكون مناسبتكم مميزة ومريحة في نفس الوقت.
                </p>
              </div>
            ...
            <div className={`relative transition-all duration-1000 ${
              ...
              <div className="relative overflow-hidden rounded-[2rem] shadow-[0_24px_80px_rgba(0,0,0,0.12)]">
                <img
                  src="https://images.pexels.com/photos/1444442/pexels-photo-1444442.jpeg?auto=compress&cs=tinysrgb&w=800"
                  alt="قاعة الذهبية - التصميم العصري"
        ...
        <div className="max-w-6xl mx-auto px-8 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[#766B5A] font-light max-w-2xl mx-auto">
              اكتشف جمال قاعة الذهبية من خلال صورنا المختارة
            </p>
          </div>
      ...
      <section className="py-32 bg-gradient-to-b from-[#FAF9F7] to-[#F8F6F2] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-8 lg:px-12 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[#766B5A] font-light max-w-2xl mx-auto">
              اكتشف ما يقوله عملاؤنا عن تجربتهم في قاعة الذهبية
            </p>
          </div>
      ...
      <section ref={decisionRef} className="py-32 bg-gradient-to-br from-white to-[#FAF9F7]">
        <div className="max-w-6xl mx-auto px-8 lg:px-12">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extralight text-[#2D2926] mb-8 tracking-[0.05em]">
              هل قاعة الذهبية مناسبة لكم؟
            </h2>
            <p className="text-xl text-[#766B5A] font-light max-w-2xl mx-auto">
              قاعة الذهبية مثالية للعائلات التي تبحث عن الفخامة والحداثة
            </p>
          </div>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 gap-12 transition-all duration-1000 ${
            ...
            <div>
              <h3 className="text-2xl font-light text-[#2D2926] mb-6 tracking-wide text-right">
                قاعة الذهبية مناسبة لكم إذا كنتم:
              </h3>
              <div className="space-y-4">
                {[
                  { text: 'تخططون لحفل متوسط مع 150-300 ضيف', icon: Users },
                  { text: 'تبحثون عن قاعة فاخرة بتصميم عصري', icon: Crown },
                  { text: 'تريدون إضاءة متطورة وتصميم حديث', icon: Star },
      ...
      <section ref={ctaRef} className="py-32 bg-gradient-to-br from-[#2D2926] to-[#1a1a1a] relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.pexels.com/photos/1444424/pexels-photo-1444424.jpeg?auto=compress&cs=tinysrgb&w=1600"
            alt="Background"
        ...
        <div className={`max-w-4xl mx-auto px-8 text-center relative z-10 transition-all duration-1000 ${
          ...
          <h2 className="text-5xl md:text-6xl font-extralight text-white mb-8 tracking-[0.05em]">
            احجزوا قاعة الذهبية الآن
          </h2>
          
          <p className="text-xl text-white/80 mb-12 leading-relaxed font-light max-w-2xl mx-auto">
            دعوا قاعة الذهبية تكون مسرح أحلامكم وتخلقوا ذكريات تدوم للأبد
          </p>
