...
interface GoldenHallWizardProps {
  isOpen: boolean
  onClose: () => void
}

export default function GoldenHallWizard({ isOpen, onClose }: GoldenHallWizardProps) {
    ...
    try {
      ...
      successMessage.innerHTML = `
        <div class="bg-white rounded-3xl p-8 max-w-md w-full text-center shadow-[0_32px_128px_rgba(0,0,0,0.2)]">
          ...
          <p class="text-gray-600 mb-6">سنقوم بالتواصل معكم قريباً لتأكيد التفاصيل وتقديم العرض المخصص للقاعة الذهبية</p>
  ...
  const renderStep1 = () => (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 text-right mb-6">أخبرنا عن مناسبتكم لنقدم لكم أفضل عرض مخصص للقاعة الذهبية - قاعة أنيقة وعصرية بسعة 250 ضيف</p>
  ...
  const renderStep2 = () => (
    <div className="space-y-8">
      <div>
        <h3 className="text-2xl font-light text-[#2D2926] mb-6 text-right">تخصيص القاعة الذهبية</h3>
        <p className="text-gray-600 text-right mb-6">اختر التصميم والإعدادات المناسبة للقاعة الذهبية - قاعة أنيقة وعصرية مع إضاءة متطورة ونظام صوت احترافي</p>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { value: 'classic', label: 'كلاسيكي أنيق (مستطيلات أو مربعات)', image: 'https://images.pexels.com/photos/1444442/pexels-photo-1444442.jpeg?auto=compress&cs=tinysrgb&w=300' },
              { value: 'circular', label: 'دائري أنيق', image: 'https://images.pexels.com/photos/1444424/pexels-photo-1444424.jpeg?auto=compress&cs=tinysrgb&w=300' },
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { value: 'classic', label: 'إضاءة كلاسيكية أنيقة' },
  ...
  const renderStep3 = () => (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 text-right mb-6">اختر الخدمات التي تريدها للقاعة الذهبية مع نظام صوت احترافي وإضاءة متطورة</p>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { value: 'buffet', label: 'بوفيه أنيق مفتوح' },
  ...
  const renderStep4 = () => (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 text-right mb-6">اختر الإضافات التي تريدها للقاعة الذهبية مع التصميم العصري والأنيق</p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            { value: 'bridal-suite', label: 'كوشة عروس أنيقة', icon: Crown },
            { value: 'stage', label: 'تجهيز المسرح', icon: Star },
            { value: 'special-effects', label: 'مؤثرات خاصة (دخان، إضاءة ليزر، شلال شرارات)', icon: Star },
            { value: 'aisle', label: 'تخصيص الممر الرئيسي', icon: Flower },
  ...
  const renderStep5 = () => (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 text-right mb-6">أخبرنا كيف يمكننا التواصل معكم لتقديم العرض المخصص للقاعة الذهبية</p>
        ...
        <div className="sticky top-0 bg-white rounded-t-3xl p-8 border-b border-gray-100">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">القاعة الذهبية - مافيرا</p>
            </div>
