    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div
            className="absolute top-3/4 right-1/3 w-2 h-2 bg-[#C49D2F]/20 rounded-full animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-1/4 left-1/2 w-1 h-1 bg-[#C49D2F]/40 rounded-full animate-pulse"
        ...
        <div className="relative z-10 text-center px-8 max-w-5xl mx-auto">
          ...
          <h1
            className="text-6xl md:text-8xl font-extralight text-[#2D2926] mb-12 tracking-[0.1em] leading-[0.9]"
            style={{
          ...
          <p className="text-2xl md:text-3xl text-[#766B5A] font-light tracking-[0.05em] leading-relaxed max-w-3xl mx-auto">
            ...
            <span className="block mt-2 text-xl opacity-70">
              قصص نجاح تحكي عن تجارب استثنائية
            </span>
          </p>
        </div>
      </section>
                ...
                <div className="flex justify-center mb-12">
                  {[...Array(testimonials[currentTestimonial].rating)].map(
                    (_, i) => (
                      <Star
                        key={i}
                        className="w-8 h-8 text-[#C49D2F] fill-current mx-1"
                      />
                    )
                  )}
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            {[
              ...
              >
                ...
                <div className="text-4xl font-extralight text-[#C49D2F] mb-3">
                  {stat.number}
                </div>
                <div className="text-[#766B5A] text-lg font-light">
                  {stat.label}
                </div>
              </div>
            ))}
