...
interface FlowerHallWizardProps {
  isOpen: boolean
  onClose: () => void
}

export default function FlowerHallWizard({ isOpen, onClose }: FlowerHallWizardProps) {
    ...
    try {
      ...
      successMessage.innerHTML = `
        <div class="bg-white rounded-3xl p-8 max-w-md w-full text-center shadow-[0_32px_128px_rgba(0,0,0,0.2)]">
          ...
          <p class="text-gray-600 mb-6">سنقوم بالتواصل معكم قريباً لتأكيد التفاصيل وتقديم العرض المخصص</p>
  ...
  const renderStep1 = () => (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 text-right mb-6">أخبرنا عن مناسبتكم لنقدم لكم أفضل عرض مخصص ومفصل ومثالي ومتكامل وشامل ومفصل وكامل وشامل ومفصل وكامل</p>
  ...
  const renderStep2 = () => (
    <div className="space-y-8">
      <div>
        <h3 className="text-2xl font-light text-[#2D2926] mb-6 text-right">تخصيص القاعة</h3>
        <p className="text-gray-600 text-right mb-6">اختر التصميم والإعدادات المناسبة لجعل مناسبتكم مثالية وأنيقة وفاخرة ومميزة ومتكاملة وشاملة ومفصلة وكاملة وشاملة ومفصلة</p>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { value: 'classic', label: 'كلاسيكي (مستطيلات أو مربعات)', image: 'https://images.pexels.com/photos/1444442/pexels-photo-1444442.jpeg?auto=compress&cs=tinysrgb&w=300' },
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { value: 'classic', label: 'إضاءة كلاسيكية' },
  ...
  const renderStep3 = () => (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 text-right mb-6">اختر الخدمات التي تريدها لجعل مناسبتكم مميزة ومريحة ومثالية ومتكاملة وشاملة ومفصلة وكاملة وشاملة ومفصلة وكاملة</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { value: 'sound', label: 'نظام صوت', icon: Music },
  ...
  const renderStep4 = () => (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 text-right mb-6">اختر الإضافات التي تريدها لجعل مناسبتكم أكثر تميزاً وفخامة وروعة وخصوصية وتميزاً وخصوصية وتميزاً وخصوصية وتميزاً وخصوصية وتميزاً</p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            { value: 'bridal-suite', label: 'كوشة عروس', icon: Crown },
  ...
  const renderStep5 = () => (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 text-right mb-6">أخبرنا كيف يمكننا التواصل معكم لتقديم العرض المخصص والتفاصيل الكاملة والشاملة والمفصلة والكاملة والشاملة والمفصلة والكاملة والشاملة</p>
        ...
        <div className="sticky top-0 bg-white rounded-t-3xl p-8 border-b border-gray-100">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">قاعة الأزهار - مافيرا</p>
            </div>
